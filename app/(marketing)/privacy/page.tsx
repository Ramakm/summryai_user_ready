	...
	return (
		<MaxWidthWrapper className="mx-auto mb-40 max-w-3xl px-8">
			<AnimationContainer delay={0.1} className="w-full">
				...
				<h2 className="mt-8 font-medium text-xl">Information We Collect</h2>
				...
				<h3 className="mt-12 font-medium text-lg">Non-Personal Information</h3>
				<p className="mt-8 text-muted-foreground">
				...
				<h3 className="mt-8 font-medium text-lg">
				...
				<h3 className="mt-12 font-medium text-xl">Communication</h3>
				<div className="mt-8">
				...
				<h2 className="mt-12 font-medium text-xl">Data Security</h2>
				<p className="mt-8 text-muted-foreground">
				...
				<h2 className="mt-12 font-medium text-xl">Data Retention</h2>
				<p className="mt-8 text-muted-foreground">
				...
				<h2 className="mt-12 font-medium text-xl">Your Rights and Choices</h2>
				...
				<p className="mt-8 text-muted-foreground">
					...
					information. Please contact us at anayat0khan@gmail.com to make this
					request.
				</p>

				<h2 className="mt-12 font-medium text-xl">Children&apos;s Privacy</h2>
				<p className="mt-8 text-muted-foreground">
