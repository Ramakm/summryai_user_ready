	...
	return (
		<MaxWidthWrapper className="mx-auto mb-40 max-w-3xl px-8">
			<AnimationContainer delay={0.1} className="w-full">
				...
				<p className="mt-4">
					Welcome to Summry. These terms and conditions outline the rules and
					regulations for the use of Summry&apos;s website and services.
				</p>

				<h2 className="mt-8 font-medium text-xl">Acceptance of Terms</h2>

				<p className="mt-8 text-muted-foreground">
					By accessing and using Summry, you accept and agree to be bound by
				...
				<p className="mt-8 text-muted-foreground">
					Summry reserves the right to modify these terms at any time. We will
				...
				<p className="mt-8">
					To use Summry, you must be at least 18 years old and capable of
				...
				<div className="mt-8">
					You agree not to use Summry for any unlawful or prohibited activities,
				...
				<p className="mt-8 text-muted-foreground">
					Summry provides a AI powered blog generater service that allows you to
					create content from the media. You agree not to use this service to
