				...
				>
					<AnimationContainer className="flex w-full flex-col items-center justify-center text-center">
						<button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
							<span>
								<span className="spark mask-gradient absolute inset-0 h-[100%] w-[100%] animate-flip overflow-hidden rounded-full bg-green-500 [mask:linear-gradient(white,_transparent_50%)] before:absolute before:aspect-square before:w-[200%] before:rotate-[-90deg] before:animate-rotate before:bg-[conic-gradient(from_0deg,transparent_0_340deg,white_360deg)] before:content-[''] before:[inset:0_auto_auto_50%] before:[translate:-50%_-15%]" />
							</span>
							...
							<span className="absolute inset-x-0 bottom-0 h-full w-full bg-gradient-to-tr from-green-400/20 blur-md"></span>
							<span className="z-10 flex items-center justify-center gap-1 py-0.5 text-white text-sm">
								✨ Introduction Summry AI
								<ArrowRightIcon className="ml-1 size-3 text-green-400 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
							</span>
						</button>
						<h1 className="!leading-[1.15] w-full text-balance py-6 text-center font-heading font-medium text-5xl text-white tracking-normal sm:text-6xl md:text-7xl lg:text-8xl">
							AI-Powered Summary With{" "}
							<span className="inline-bloc bg-gradient-to-r from-green-400 to-violet-500 bg-clip-text text-transparent">
								Any Media
							</span>
						</h1>
						<p className="mb-12 text-balance text-lg text-neutral-300 tracking-tight md:text-xl">
							Create high-quality documentation with videos,
						...
						<div className="z-50 flex items-center justify-center gap-4 whitespace-nowrap">
							<Button asChild className="bg-green-500 hover:bg-violet-400 text-white">
								<Link
			...
			<MaxWidthWrapper>
				<AnimationContainer delay={0.4}>
					<div className="py-14">
						...
						<h2 className="text-center font-heading font-medium text-green-400 text-sm uppercase">
			...
			<MaxWidthWrapper className="pt-10">
				<AnimationContainer delay={0.1}>
					...
					>
						...
						<h2 className="!leading-[1.1] mt-6 text-center font-heading font-medium text-3xl text-green-400 md:text-5xl lg:text-center">
						Manage Blogs Like a Pro
						</h2>
						<p className="mt-4 max-w-lg text-center text-lg text-green-200 lg:text-center">
						Summry AI is a cutting-edge blog generation tool that delivers content-driven blogs in just seconds.
						</p>
			...
			<MaxWidthWrapper className="py-10">
				<AnimationContainer delay={0.1}>
					...
					>
						...
						<p className="mt-4 max-w-lg text-center text-lg text-green-200 lg:text-center">
						Get started with Summry today and enjoy more features with our pro plans.
						</p>
			...
			<MaxWidthWrapper className="py-10">
				<AnimationContainer delay={0.1}>
					...
					>
						...
						<p className="mt-4 max-w-lg text-center text-lg text-green-200 lg:text-center">
						Here&apos;s what some of our users have to say about Summry.
						</p>
			...
			<MaxWidthWrapper className="scrollbar-hide mt-20 max-w-[100vw] overflow-x-hidden">
				<AnimationContainer delay={0.1}>
					<LampContainer>
						...
						<h2 className="!leading-[1.15] mt-8 bg-gradient-to-b from-green-200 to-violet-500 bg-clip-text py-4 text-center font-heading font-medium text-4xl text-transparent tracking-tight md:text-7xl">
						Step into the Future of AI <br />
						Content Creation
						</h2>
						<p className="mx-auto mt-6 max-w-md text-green-200">
						Unlock the future of content creation with our cutting-edge, AI-powered platform. Let AI do the heavy lifting, so you can focus on what matters most—your ideas.
						</p>
